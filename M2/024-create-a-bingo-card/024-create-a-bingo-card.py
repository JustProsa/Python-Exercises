...
keys_list = list(bingo.keys())
values_list = list(bingo.values())


bingo_card = random.randint(0, len(keys_list))
bingo_number = random.randint(0, 15)

print("BINGO CARD:")
print(str(keys_list[bingo_card]), end= " ")
print(values_list[bingo_card][bingo_number])
